...
buildTimeLine = function(times) {
  var TimeLine, addHover, alternateDate, bigPoint, canvasHeight, canvasWidth, dayFinish, dayStart, dayTime, drawBigPoints, getToday, getUseParams, height, hour, hourText, hoursToMs, line, lineText, markLine, minutes, offset, s, smallMarkLine, smallPoint, timeLine, ts;
  canvasWidth = 500;
  canvasHeight = 0;
  height = 2;
  dayStart = 8;
  ...
  drawBigPoints();
  return times.forEach(function(e) {
